...
func (cq *CarQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (cq *CarQuery) FirstIDX(ctx context.Context) int64 {
...
func (cq *CarQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (cq *CarQuery) OnlyIDX(ctx context.Context) int64 {
...
func (cq *CarQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (cq *CarQuery) IDsX(ctx context.Context) []int64 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
