...
require (
	...
	github.com/lovechung/api-base v0.0.8
	github.com/lovechung/go-kit v0.1.1
	github.com/rueian/rueidis v0.0.54
...
require (
	...
	github.com/go-kratos/kratos/contrib/config/consul/v2 v2.0.0-20220604031450-874d4c3edcf5 // indirect
